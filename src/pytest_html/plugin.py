...
class HTMLReport:
    ...
    def _generate_report(self, session):
        ...
        summary = [
            html.p(f"{numtests} Test Cases ran in {suite_time_delta:.2f} seconds. "),
            html.h4(f"{passtests / numtests * 100:.2f}% Passed "),
            html.h2(f"Cost: {suite_time_delta/60*12.45:.2f} Indian Rupee"),
            html.p("Assuming: $1=73.29	and cost per minute=$.17"),
